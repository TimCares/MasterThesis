...
However, existing approaches often require large-scale models, extensive data, and substantial computational resources,
limiting their accessibility for smaller research groups and individuals.
This thesis addresses this issue by introducing an efficient self-supervised vision-language model
...
These findings underscore the potential for designing efficient multimodal models,
