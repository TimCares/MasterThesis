...
#figure(
  ...
  caption: [Hyperparameters used for finetuning S-SMKE on MSCOCO @coco and Flickr30K @flickr30k image-text retrieval.
  The number of total steps and warmup steps are different for the two datasets, as they are different in size.
  The steps are displayed as [MSCOCO steps/Flickr30K steps].
  ],
)<s_smke_finetune_itr_hyperparams>
