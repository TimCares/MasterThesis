...
@dataclass
class MultiModalData2VecConfig(FairseqDataclass):
...
@register_model("multimodal_data2vec", dataclass=MultiModalData2VecConfig)
class MultiModalData2Vec(BaseFairseqModel):
    ...
    def _init_weights(self, m):
        if isinstance(m, nn.Linear):
            ...
            raise ValueError('Layer to initialize did not match nn.Linear or nn.LayerNorm')
