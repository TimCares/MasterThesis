...
from multimodal_data2vec_live_targets import KDMMData2VecConfig, KDSharedData2VecPreTrainingLightningModule
...
def main(cfg: DictConfig) -> None:
    ...
    module = KDSharedData2VecPreTrainingLightningModule(cfg=cfg)
